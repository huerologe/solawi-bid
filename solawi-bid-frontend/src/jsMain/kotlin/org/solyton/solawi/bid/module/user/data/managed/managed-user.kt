...
@Lensify data class ManagedUser(
    ...
    @ReadWrite val permissions: String,
)
 ...
 */
@ReadWrite val permissions: Lens<ManagedUser, String> by lazy{ Lens(
 ...
 */
@ReadWrite fun ManagedUser.permissions(set: String.()->String ): ManagedUser = copy(permissions = set(permissions)) 
