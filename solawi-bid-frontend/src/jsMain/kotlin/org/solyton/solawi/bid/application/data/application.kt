...
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [Application.isCookieDisclaimerConfirmed]
 */
@ReadWrite fun Application.isCookieDisclaimerConfirmed(set: Boolean.()->Boolean ): Application = copy(isCookieDisclaimerConfirmed = set(isCookieDisclaimerConfirmed)) 
/**
 * Autogenerated Lens.
